        ...
        <div className="project-information" onClick={() => setFlipped(state => !state)}>            
            <animated.div className="project-description" style={{ opacity: opacity.to(o => 1 - o), transform }}>
                ...
                <p>
                    ...
                    This website hosts an interactive map where users can view doctors from all over 
                    the world who have experience in treating people with PK Deficiency.                             
                </p>
                <p>
                    Users can browse the globe and click on a doctor to view their contact information.
                ...
                <p>
                    This project taught me a ton about the complete process of software development. 
                    I developed a polished web page, implemented a server to store user information, 
                    worked with third party APIs, and implemented many security measures.
                </p>
                <h2>Stack</h2>
                <div className='stack'>
